...
public class RocCommand extends AbstractCommand {
  ...
  private final static List<String> args_2_edit_tags = List.of(
      ...
      "throne-stealer.mult-normal", "throne-stealer.mult-stealing"
  );
  ...
  public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args) {
    ...
    if (arg.equalsIgnoreCase("config")) {
      ...
      if (arg.equalsIgnoreCase("edit.tags")) {
        ...
        boolean isSuccess = switch (property) {
          ...
          case "regicide.attack.king.mult" ->
              setDouble(sender, value, tags::setRegicideAttackMultiplicativeKing, success);
          case "regicide.attack.others.flat" -> setDouble(sender, value, tags::setRegicideAttackFlatOthers, success);
          case "regicide.attack.others.mult" ->
              setDouble(sender, value, tags::setRegicideAttackMultiplicativeOthers, success);
          case "regicide.defend.king.flat" -> setDouble(sender, value, tags::setRegicideDefendFlatKing, success);
          case "regicide.defend.king.mult" ->
              setDouble(sender, value, tags::setRegicideDefendMultiplicativeKing, success);
          case "regicide.defend.others.flat" -> setDouble(sender, value, tags::setRegicideDefendFlatOthers, success);
          case "regicide.defend.others.mult" ->
              setDouble(sender, value, tags::setRegicideDefendMultiplicativeOthers, success);
          ...
          case "ninja.disable-stealth-on-capture" ->
              setBool(sender, value, tags::setNinjaCaptureDisableStealth, success);
          case "throne-stealer.mult-normal" -> setDouble(sender, value, tags::setThroneStealerModifierNormal, success);
          case "throne-stealer.mult-stealing" ->
              setDouble(sender, value, tags::setThroneStealerModifierStealing, success);
      ...
      if (arg.equalsIgnoreCase("edit.pickups")) {
        ...
        if (arg.equals("add")) {
          ...
          try {
            ...
            return error(sender, "Invalid material '" + args[3] + "'.");
          }
          try {
            ...
            return error(sender, "Invalid score (int) '" + args[4] + "'.");
          }
          try {
            chance = Double.parseDouble(args[5]);
          } catch (Exception e) {
            return error(sender, "Invalid chance (double) '" + args[5] + "'.");
          }
          try {
            color = parseColor(args[6]);
          } catch (Exception e) {
            return error(sender, "Invalid color (r,g,b) '" + args[5] + "' : " + e.getMessage());
          }
    ...
    if (arg.equalsIgnoreCase("kits")) {
      ...
      if (arg.equalsIgnoreCase("from-inventory.new")) {
        if (args.length < 2)
          return error(sender, "Argument missing. Syntax: \"/" + label + ", kits " + arg + " §4<id> <display name>§c.\"");
        String id = args[0];
